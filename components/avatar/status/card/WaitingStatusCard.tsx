...
export default (props: Props) => {
    ...
    const renderButton = () => {
        if (props.status === "generating") return <div className="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
            ...
            <a href="https://buy.stripe.com/eVa9E655Wfs269WdQY">
