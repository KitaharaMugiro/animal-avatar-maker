...
import AvatarGenerateForFreeCampaign from "../../../components/avatar/AvatarGenerateForFreeCampaign"
...
export default ({ inputImages }: { inputImages: CloudinaryImageProps[] }) => {
    ...
    return (
        <>
            ...
            <MyHeader />
            <AvatarGenerateForFreeCampaign name={name as string} inputImages={inputImages} />
